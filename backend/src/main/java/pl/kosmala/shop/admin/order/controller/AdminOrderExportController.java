...
import pl.kosmala.shop.admin.order.service.AdminExportService;
...
@RestController
@RequestMapping("/api/v1/admin/orders/export")
...
public class AdminOrderExportController
{
    ...
    {
        System.out.println(LocalDateTime.of(from, LocalTime.of(0,0,0)));
        System.out.println(LocalDateTime.of(to, LocalTime.of(23,59,59)));
        List<AdminOrder> adminOrdersToExport = adminExportService.exportOrders
                (
                        LocalDateTime.of(from, LocalTime.of(0,0,0)),
                        LocalDateTime.of(to, LocalTime.of(23,59,59)),
                        orderStatus
                );
        ByteArrayInputStream byteArrayInputStream = transformToCsv(adminOrdersToExport);
